...
.L276:
	...
	out 0x15,r25
/* #APP */
 ;  267 "csb-light-grb-3.4a.c" 1
	sei
 ;  0 "" 2
/* #NOAPP */
	sts power,__zero_reg__
/* #APP */
 ;  269 "csb-light-grb-3.4a.c" 1
	sleep
