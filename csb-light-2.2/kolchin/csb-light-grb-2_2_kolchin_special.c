...
unsigned char make_color( unsigned char c ){
	...
	switch (c){
		...
		case 2:
			return make_light( FULL_LIGHT, HALF_HALF_LIGHT, 0 );	//
		case 3:
			return make_light( FULL_LIGHT, HALF_LIGHT, 0 );	//
		}
			
	switch (c){
		case 4: 
			return make_light( FULL_LIGHT, FULL_LIGHT, 0 );	//
		case 5:
			return make_light( HALF_LIGHT, FULL_LIGHT, 0 );	//
		case 6:
			return make_light( HALF_HALF_LIGHT, FULL_LIGHT, 0 );	//
		}
			
	switch (c){	
		case 7:
			return make_light( 0, FULL_LIGHT, 0 );	//case 3:		
		case 8:
			return make_light( 0, FULL_LIGHT, HALF_HALF_LIGHT );	//case 3:
		case 9:
			return make_light( 0, FULL_LIGHT, HALF_LIGHT );	//case 3:
		}
		
	switch (c){	
		case 10:
			return make_light( 0, FULL_LIGHT, FULL_LIGHT);	//case 3:		
		case 11:
			return make_light( 0, HALF_LIGHT, FULL_LIGHT);	//case 3:
		case 12:
			return make_light( 0, HALF_HALF_LIGHT, FULL_LIGHT);	//case 3:
		}		
		
	switch (c){	
		case 13:
			return make_light( 0, 0, FULL_LIGHT);	//case 3:		
		case 14:
			return make_light( HALF_HALF_LIGHT, 0, FULL_LIGHT);	//case 3:
		case 15:
			return make_light( HALF_LIGHT, 0, FULL_LIGHT);	//case 3:
		}		
		
		
	switch (c){	
		case 16:
			return make_light( FULL_LIGHT, 0, FULL_LIGHT);	//case 3:		
		case 17:
			return make_light( FULL_LIGHT, 0, HALF_LIGHT);	//case 3:
		case 18:
			return make_light( FULL_LIGHT, 0, HALF_HALF_LIGHT);	//case 3:
		}		
		
	switch (c){	
		case 19:
			return make_light( FULL_LIGHT, HALF_HALF_LIGHT, HALF_HALF_LIGHT);	//case 3:		
		case 20:
			return make_light( FULL_LIGHT, HALF_LIGHT, HALF_LIGHT);	//case 3:
		case 21:
			return make_light( FULL_LIGHT, FULL_LIGHT, FULL_LIGHT);	//case 3:
		}			
		
		
	switch (c){	
		case 22:
			return make_rainbow(1);	
		case 23:
			return make_rainbow(10);	
		case 24:
			return make_rainbow(30);	
		}			
	switch (c){	
		case 25:
			return make_rainbow(50);	
		case 26:
			return make_rainbow(150);	
		case 27:
			return make_rainbow(255);	
		}		
	return make_light( 0, 0, 0 );
}
